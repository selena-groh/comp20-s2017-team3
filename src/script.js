...
//Instructions pop up box
  ...
  BootstrapDialog.show({
    title: '<h1> Instructions </h1>',
      message: "<p>Get four in a row horizontally, vertically, or diagonally to win!</p> <p> On each turn use your number keys (1 through 7) </br> to place your pieces in the corresponding columns </br> or press &#39;f&#39; to flip the direction of gravity! </p> <p>  Press &#39;r&#39; to restart the current game. </p> <p> Press &#39;n&#39; to start a new game, which resets the player win count. </p> <img src='../res/instructions.gif'>",
      buttons: [{
        label: 'Play!',
          action: function(dialog) {
            dialog.close();
